Public Class frmSlabCon
    ...
    Public Sub RefreshVane(ByVal i As Integer)
        ...
        Dim nMount As Integer = Math.Truncate(Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass.Length / 10) + 1
        Dim s As New Steema.TeeChart.Styles.Line
        Dim a(0 To nMount - 1) As Double
        Dim b(0 To nMount - 1) As Double
        For n As Integer = 0 To nMount - 1
            If n = nMount - 1 Then
                a(n) = Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass(Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass.Length - 1).m_x
                b(n) = Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass(Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass.Length - 1).m_C
            Else
                a(n) = Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass(n * 10).m_x
                b(n) = Project0.Dis0.Heavy(i).SlabHeavy.SlabMetAndMass.slabAirMass(n * 10).m_C
            End If
