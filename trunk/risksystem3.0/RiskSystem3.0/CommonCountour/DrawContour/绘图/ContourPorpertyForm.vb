...
Public Class ContourPorpertyForm
    ...
    Private Sub ContourPorpertyForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not SettingPannel Is Nothing Then
            ...
            For i = 0 To ActivePaintForm.ContourPaintSetting.ContourPannel.Contours.ContourValueSetting.ContourValue.Length - 1
        ...
        If Not SettingPannel Is Nothing Then
            ...
            Select Case listAxis.SelectedIndex
                Case 0 '左轴
                    ...
                    Dim LinePen As New Pen(Color.FromArgb(PenProperty.color), PenProperty.WidthReal)
                    LinePen.DashStyle = PenProperty.DashStyle
                    e.Graphics.DrawLine(LinePen, 0, CInt(e.ClipRectangle.Height / 2), CInt(e.ClipRectangle.Width), CInt(e.ClipRectangle.Height / 2))
                Case 1 '底轴
        ...
        If Not SettingPannel Is Nothing Then
            ...
            Select Case listAxis.SelectedIndex
                Case 0 '左轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.LeftAxis.AxisLine.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.LeftAxis.AxisLine.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
                ...
                Case 1 '底轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.BottomAxis.AxisLine.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.BottomAxis.AxisLine.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
                ...
                Case 2 '右轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.RightAxis.AxisLine.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.RightAxis.AxisLine.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
                ...
                Case 3 '顶轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.TopAxis.AxisLine.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.TopAxis.AxisLine.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
        ...
        If Not SettingPannel Is Nothing Then
            ...
            Select Case listAxis.SelectedIndex
                Case 0 '左轴
                    ...
                    ScalePen.Width = SettingPannel.Axes.LeftAxis.MainAxisScale.PenProperty.WidthReal
                    ScalePen.DashStyle = SettingPannel.Axes.LeftAxis.MainAxisScale.PenProperty.DashStyle
                    e.Graphics.DrawLine(ScalePen, 0, CInt(e.ClipRectangle.Height / 2), CInt(e.ClipRectangle.Width), CInt(e.ClipRectangle.Height / 2))
                Case 1 '底轴
                    Dim ScalePen As New Pen(Color.FromArgb(SettingPannel.Axes.BottomAxis.MainAxisScale.PenProperty.color))
                    ScalePen.Width = SettingPannel.Axes.BottomAxis.MainAxisScale.PenProperty.WidthReal
                ...
                Case 2 '右轴
                    ...
                    ScalePen.Width = SettingPannel.Axes.RightAxis.MainAxisScale.PenProperty.WidthReal
                ...
                Case 3 '顶轴
                    ...
                    ScalePen.Width = SettingPannel.Axes.TopAxis.MainAxisScale.PenProperty.WidthReal
        ...
        If Not SettingPannel Is Nothing Then
            ...
            Select Case listAxis.SelectedIndex
                Case 0 '左轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.LeftAxis.MainAxisScale.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.LeftAxis.MainAxisScale.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
                ...
                Case 1 '底轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.BottomAxis.MainAxisScale.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.BottomAxis.MainAxisScale.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
                ...
                Case 2 '右轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.RightAxis.MainAxisScale.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.RightAxis.MainAxisScale.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
                ...
                Case 3 '顶轴
                    ...
                    frmLineStyle.penCurLineStyle.Width = SettingPannel.Axes.TopAxis.MainAxisScale.PenProperty.WidthReal
                    ...
                    If frmLineStyle.ShowDialog() = Windows.Forms.DialogResult.OK Then '如果用户点击确定，则将线形编程器的画笔给当前画笔
                        ...
                        SettingPannel.Axes.TopAxis.MainAxisScale.PenProperty.WidthReal = frmLineStyle.penCurLineStyle.Width
        ...
        If Not SettingPannel Is Nothing Then
            ...
            Select Case listAxis.SelectedIndex
                Case 0, 2 '左轴右轴
                    ...
                    AxisGriddingPen.Width = SettingPannel.Axes.LeftAxis.AxisGridding.PenProperty.WidthReal
                    AxisGriddingPen.DashStyle = SettingPannel.Axes.LeftAxis.AxisGridding.PenProperty.DashStyle

                    e.Graphics.DrawLine(AxisGriddingPen, 0, CInt(e.ClipRectangle.Height / 2), CInt(e.ClipRectangle.Width), CInt(e.ClipRectangle.Height / 2))

                    AxisGriddingPen.Color = Color.FromArgb(SettingPannel.Axes.RightAxis.AxisGridding.PenProperty.color)
                    AxisGriddingPen.Width = SettingPannel.Axes.RightAxis.AxisGridding.PenProperty.WidthReal
                ...
                Case 1, 3 '底轴顶轴
                    ...
                    AxisGriddingPen.Width = SettingPannel.Axes.BottomAxis.AxisGridding.PenProperty.WidthReal
                    ...
                    AxisGriddingPen.Width = SettingPannel.Axes.TopAxis.AxisGridding.PenProperty.WidthReal
    ...
    Private Sub cmdSetContours_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSetContours.Click
        ...
        If newdlgInitialContour.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            If newdlgInitialContour.RadioButtonGrade.Checked = True Then
                ...
                ActivePaintForm.ContourPaintSetting.ResetCountData()
                '重新计算等值线及区域 Else
                SettingPannel.Contours.ReCalContour = True
            Else
                '设置等值线值的类型
