...
#End Region
    ...
    Private Sub SetContour()
        ...
        If ContourPorpertyForm.ShowDialog() = DialogResult.OK Then
            functionContourSetChanged()
        End If
    End Sub
    ...
    Public Sub zoomin(ByVal point As PointF)
        If PannelSetting.gScale < 0.001 Then
            Exit Sub
        End If
...
#Region "事件"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Event ContourSetChanged()

    Public Sub functionContourSetChanged()
        RaiseEvent ContourSetChanged()
    End Sub
#End Region

    Private Sub 平面布置图可见PToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles 平面布置图可见PToolStripMenuItem.Click
        ImagePlaneVisible(Me.ContourPaintSetting.ContourPannel)
    End Sub

    Private Sub 平面布置图可见PToolStripMenuItem_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles 平面布置图可见PToolStripMenuItem.Paint
        If Me.ContourPaintSetting.ContourPannel.PlanImage.BackVisible = True Then
            平面布置图可见PToolStripMenuItem.Checked = True
        Else
            平面布置图可见PToolStripMenuItem.Checked = False
        End If
    End Sub
End Class
