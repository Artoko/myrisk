...
#Region "属性"
    ...
    Private m_PopulationRegions As New PopulationRegions '敏感区的人口类
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property PopulationRegions() As PopulationRegions
        Get
            Return Me.m_PopulationRegions
        End Get
        Set(ByVal value As PopulationRegions)
...
#Region "方法"
    ...
    End Sub
    Public Sub SetPopulation()
        Me.PopulationRegions.SetPopulations(Me.m_Grid)
    End Sub
#End Region
End Class
