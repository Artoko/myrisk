    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        Else
            ...
            If txtSn.Text = strcl Then
                ...
                My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\SOFTWARE\Safety", "Name", Me.txtName.Text) '注册表中的字符串是2次加密的
                My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\SOFTWARE\Safety", "Value2", jm.Encrypto(jm.Encrypto(CalStr))) '注册表中的字符串是2次加密的
                My.Computer.Registry.SetValue("HKEY_LOCAL_MACHINE\SOFTWARE\Safety", "Value3", jm.Encrypto(jm.Encrypto(jm.Encrypto(CalStr)))) '注册表中的字符串是3次加密的
