                ...
                Case 0 'TNT爆炸
                    ...
                    For k As Integer = 0 To Project0.FAndB.UVCE.DestroyRr.Length - 1
                        If Project0.FAndB.UVCE.DestroyRr(k).Selected Then
                            ...
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.UVCE.DestroyRr(k).MDrangName & "半径"
                ...
                Case 1 '凝聚相
                    ...
                    For k As Integer = 0 To Project0.FAndB.MaterialTNT.DestroyRr.Length - 1
                        If Project0.FAndB.MaterialTNT.DestroyRr(k).Selected Then
                            ...
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.MaterialTNT.DestroyRr(k).MDrangName & "半径"
                ...
                Case 2 '加油站
                    ...
                    For k As Integer = 0 To Project0.FAndB.GasStation.DestroyRr.Length - 1
                        If Project0.FAndB.GasStation.DestroyRr(k).Selected Then
                            ...
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.GasStation.DestroyRr(k).MDrangName & "半径"
                ...
                Case 3 '物理爆炸
                    ...
                    For k As Integer = 0 To Project0.FAndB.PhysicsExplode.DestroyRr.Length - 1
                        If Project0.FAndB.PhysicsExplode.DestroyRr(k).Selected Then
                            ...
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.PhysicsExplode.DestroyRr(k).MDrangName & "半径"
                ...
                Case 10 '池火灾
                    ...
                    For k As Integer = 0 To Project0.FAndB.PoolFire.ArrHeatEradiate.Length - 1
                        If Project0.FAndB.PoolFire.ArrHeatEradiate(k).Checkd Then
                            ...
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.PoolFire.ArrHeatEradiate(k).HeatName & "半径"
                ...
                Case 11 'BLEVE
                    ...
                    For k As Integer = 0 To Project0.FAndB.Bleve.ArrHeatEradiate.Length - 1
                        If Project0.FAndB.Bleve.ArrHeatEradiate(k).Checkd Then
                            ...
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.Bleve.ArrHeatEradiate(k).HeatName & "半径"
                ...
                Case 12 '固体火灾
                    ...
                    For k As Integer = 0 To Project0.FAndB.SolidFire.ArrHeatEradiate.Length - 1
                        If Project0.FAndB.SolidFire.ArrHeatEradiate(k).Checkd Then
                            ...
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.SolidFire.ArrHeatEradiate(k).HeatName & "半径"
                ...
                Case 13 '喷射火
                    ...
                    For k As Integer = 0 To Project0.FAndB.Jet.JetFire.ArrHeatEradiate.Length - 1
                        If Project0.FAndB.Jet.JetFire.ArrHeatEradiate(k).Checkd Then
                            '设置事故名称
                            ReDim Preserve .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length)
                            .ContourPannel.Contours.ContourValueSetting.ContourNames(.ContourPannel.Contours.ContourValueSetting.ContourNames.Length - 1) = Project0.FAndB.Jet.JetFire.ArrHeatEradiate(k).HeatName & "范围"
